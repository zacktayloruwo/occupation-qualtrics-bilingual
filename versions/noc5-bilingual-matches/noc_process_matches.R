# Version: noc5-bilingual-matches
# Builds noc2021_bilingual_matches.js -- all ~500 NOC 2021 5-digit unit groups,
# EN + FR, each with its illustrative-example occupation titles.
#
...
# Writes to   <project root>/versions/noc5-bilingual-matches/
...
js_code <- paste0("window.nocMatches = window.nocMatches || ", json_code, ";")

# Write to file (UTF-8)
writeLines(
  js_code,
  here::here("versions", "noc5-bilingual-matches", "noc2021_bilingual_matches.js"),
  useBytes = TRUE
)
