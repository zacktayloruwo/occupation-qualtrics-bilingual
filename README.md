...
The data were retrieved from: <https://open.canada.ca/data/en/dataset/1feee3b5-8068-4dbb-b361-180875837593>. The `noc2021_bilingual.js` file is created by the R script `noc_process.R`, which reads in and processes `noc_2021_version_1.0_-_elements.csv`, `noc_2021_version_1.0_-_elements-additional.csv`, and `cnp_2021_version_1.0_-_elements.csv`. It contains a JSON object.
...
- The files `noc2021_bilingual.js` and `occupation_selectize.js` from this repository
...
3.  Your CDN URL will be:
    ...
    ```         
    https://cdn.jsdelivr.net/gh/YOUR-USERNAME/YOUR-REPO@COMMIT-SHA/noc2021_bilingual.js
    ```

    It is currently stored on Zack Taylor's GitHub at:

    ```         
    https://cdn.jsdelivr.net/gh/zacktayloruwo/occupation-qualtrics-bilingual@main/noc2021_bilingual.js
    ```

4.  Using a commit SHA instead of `@main` prevents stale cache issues on jsDelivr.

> **Cache note:** If you update the file, push a new commit and update the SHA in the URL. To force jsDelivr to serve a fresh copy immediately, visit: `https://purge.jsdelivr.net/gh/YOUR-USERNAME/YOUR-REPO@main/noc2021_bilingual.js`
...
``` html
<script src="https://cdn.jsdelivr.net/gh/YOUR-USERNAME/YOUR-REPO@COMMIT-SHA/noc2021_bilingual.js"></script>
